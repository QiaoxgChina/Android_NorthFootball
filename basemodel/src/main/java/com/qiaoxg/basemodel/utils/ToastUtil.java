package com.qiaoxg.basemodel.utils;
...
public class ToastUtil {
     ...
     * 短时间显示Toast
     */
    public ToastUtil shortDuration(Context context, CharSequence message) {
        if (mToast == null) {
     ...
     * 长时间显示Toast
     */
    public ToastUtil longDuration(Context context, CharSequence message) {
        if (mToast == null) {
